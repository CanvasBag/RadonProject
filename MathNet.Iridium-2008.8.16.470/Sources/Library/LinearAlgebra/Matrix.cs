...
namespace MathNet.Numerics.LinearAlgebra
{
        ...
        ICloneable
    {
        ...
        /// <summary>
        /// Inverse a diagonal of a Matrix
        /// </summary>
        /// <param name="matrixIn"></param>
        /// <returns>diagonal inverse(A)</returns>
        public Matrix InvDiagMatrix()
        {
            Matrix matrixIn = this;
            Matrix tmp = new Matrix(matrixIn.RowCount, matrixIn.ColumnCount);
            for (int i = 0; i < matrixIn.RowCount; i++)
                tmp[i, i] = 1 / matrixIn[i, i];
            return tmp;
        }
            ...
            )
        {
            ...
            double[][] newData = MatrixMultiplication.OptimizedParallel.Multiply(m1._data, m2._data);
